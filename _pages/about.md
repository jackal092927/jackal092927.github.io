...
- **Multiparameter Persistent Homology and Stability Theory**  
  Algorithmic foundations and distance computation for multiparameter persistence modules, with applications to structured data analysis.

- **Topologically-Enhanced and Interpretable Graph Learning**  
  Differentiable topological representations for graph neural networks, including principled frameworks for **explainability and rationale discovery**.

- **Non-Euclidean and Pseudo-Euclidean Representations**  
  Extensions of classical dimensionality reduction and embedding theory (e.g., MDS, Johnson–Lindenstrauss) beyond Euclidean settings.

- **Geometric and Topological Methods for AI for Science**  
...
I have served as a **Lecturer** for graduate-level algorithms courses at Rutgers University and as a **Teaching Assistant** for undergraduate and graduate courses at Purdue University.  
My teaching emphasizes **conceptual clarity, rigorous reasoning, and active problem-solving**, with a strong focus on helping students connect foundational theory with modern applications in machine learning and data science.

I am committed to mentoring students at all levels and to fostering inclusive learning environments that support diverse backgrounds and career goals.

--- -->

## Links

- **Academic CV (English)**: [HTML](https://jackal092927.github.io/files/resumes/cheng-xin-cv-academic.html) · [PDF](https://jackal092927.github.io/files/resumes/cheng-xin-cv-academic.pdf)  
- **Research Statement**: [PDF](https://jackal092927.github.io/files/research_stat.pdf)  
- **Teaching Statement**: [PDF](https://jackal092927.github.io/files/teaching_stat.pdf)  
